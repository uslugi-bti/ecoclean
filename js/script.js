...
(function() {
    const servicesData = [
        { title: "Щоденне прибирання", description: "Щоденне прибирання комерційної нерухомості — це підтримка чистоти у вашому офісі, коворкінгу або торговому приміщенні на постійній основі. Ми прибираємо загальні зони, кабінети, кухні, санвузли та інші приміщення. Наша команда працює у зручний для вас час — до початку робочого дня або після закінчення, щоб не заважати вашим співробітникам. Регулярне прибирання підвищує продуктивність, зменшує поширення бактерій та створює позитивне враження на клієнтів." },
        { title: "Прибирання після ремонту", description: "Після завершення будівельних або ремонтних робіт у приміщенні залишається значна кількість пилу, фарби, клею та будівельного сміття. Наша команда ефективно видаляє всі ці забруднення: змиває фарбу зі скла та поверхонь, прибирає будівельний пил, миє підлогу, стіни, вікна та стелі. Ми використовуємо спеціалізовані засоби та обладнання, що дозволяє швидко і якісно підготувати приміщення до заселення або відкриття." },
        { title: "Прибирання при переїзді", description: "Послуга прибирання при переїзді включає ретельне очищення квартири або будинку перед в'їздом нових мешканців або після виїзду попередніх. Ми ретельно прибираємо кожен куточок: миємо вікна, холодильник, плиту, шафи зсередини, видаляємо старі плями та запахи. Це гарантує, що ви в'їжджаєте у чисте та свіже приміщення, або здаєте квартиру в ідеальному стані." },
        { title: "Генеральне прибирання", description: "Генеральне прибирання — це найбільш повний та глибокий вид прибирання. Ми обробляємо всі поверхні: миємо вікна зсередини та назовні, чистимо килими та м'які меблі, миємо техніку всередині, прибираємо за меблями та під ними, дезінфікуємо санвузли, очищаємо плитку від вапняного нальоту. Рекомендуємо проводити генеральне прибирання кожні 3–6 місяців для підтримки здорового мікроклімату в оселі." },
        { title: "Генеральне прибирання квартир та будинків", description: "Комплексне генеральне прибирання квартир та приватних будинків включає повну обробку всіх поверхонь, меблів, вікон і побутової техніки. Ми чистимо холодильник і духовку зсередини, видаляємо жир з кухонних поверхонь, миємо плитку, чистимо ванну та унітаз від вапняного нальоту, прибираємо пил зі всіх поверхонь, миємо підлогу. Після нашого прибирання ваш дім сяятиме чистотою." },
        { title: "Миття вікон, вітрин та інших скляних поверхонь", description: "Професійне миття вікон, вітрин, скляних фасадів та інших скляних поверхонь будь-якої висоти. Ми використовуємо спеціалізоване телескопічне обладнання, системи подачі очищеної води та професійну хімію, яка не залишає розлучень. Миємо вікна зсередини та зовні, очищаємо рами та підвіконня. Результат — ідеально чисте скло без розлучень та плям." },
        { title: "Хімічне чищення", description: "Хімічне чищення м'яких меблів, матраців, килимів та інших текстильних виробів з використанням професійної техніки та засобів. Ми видаляємо навіть застарілі плями від кави, вина, жиру, а також неприємні запахи. Використовуємо гіпоалергенну хімію брендів Chemspec (США) та Kiehl (Німеччина), безпечну для людей і домашніх тварин. Ефективність видалення плям — до 95%." }
    ];
